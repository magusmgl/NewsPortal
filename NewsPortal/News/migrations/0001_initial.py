# Generated by Django 4.0.6 on 2022-07-06 10:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_type', models.CharField(choices=[('NE', 'Новости'), ('Bl', 'Блог')], default='NE', max_length=2)),
                ('post_date', models.DateField(auto_now_add=True)),
                ('post_header', models.CharField(max_length=125)),
                ('post_text', models.TextField()),
                ('_post_raing', models.FloatField(default=0.0)),
